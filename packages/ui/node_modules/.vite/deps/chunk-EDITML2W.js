...
var InMemoryCache = class extends AsyncCache {
  ...
  async get(type, key) {
    return __privateGet5(this, _caches)[type].get(key) ?? null;
  }
  async set(type, key, value) {
    __privateGet5(this, _caches)[type].set(key, value);
  }
  async delete(type, key) {
    __privateGet5(this, _caches)[type].delete(key);
  }
  async clear(type) {
    if (type) {
      __privateGet5(this, _caches)[type].clear();
    } else {
      for (const cache of Object.values(__privateGet5(this, _caches))) {
        cache.clear();
      }
    }
  }
...
var ObjectCache = class {
  constructor({ cache = new InMemoryCache(), onEffects }) {
    ...
    __privateAdd5(this, _onEffects);
    __privateSet5(this, _cache3, cache);
    __privateSet5(this, _onEffects, onEffects);
  }
  asPlugin() {
    return async (transactionData, _options, next) => {
      ...
      const cached = (await __privateGet5(this, _cache3).getObjects(unresolvedObjects)).filter(
        (obj) => obj !== null
      );
      ...
      await Promise.all(
        transactionData.commands.map(async (commands) => {
          if (commands.MoveCall?._argumentTypes) {
            await __privateGet5(this, _cache3).addMoveFunctionDefinition({
              package: commands.MoveCall.package,
              module: commands.MoveCall.module,
              function: commands.MoveCall.function,
  ...
  async clear() {
    await __privateGet5(this, _cache3).clear();
  }
  async getMoveFunctionDefinition(ref) {
    return __privateGet5(this, _cache3).getMoveFunctionDefinition(ref);
  }
  async getObjects(ids) {
    return __privateGet5(this, _cache3).getObjects(ids);
  }
  async deleteObjects(ids) {
    return __privateGet5(this, _cache3).deleteObjects(ids);
  }
  async clearOwnedObjects() {
    await __privateGet5(this, _cache3).clear("OwnedObject");
  }
  async clearCustom() {
    await __privateGet5(this, _cache3).clear("Custom");
  }
  async getCustom(key) {
    return __privateGet5(this, _cache3).getCustom(key);
  }
  async setCustom(key, value) {
    return __privateGet5(this, _cache3).setCustom(key, value);
  }
  async deleteCustom(key) {
    return __privateGet5(this, _cache3).deleteCustom(key);
  }
  async applyEffects(effects) {
    ...
    await Promise.all([
      __privateGet5(this, _cache3).addObjects(addedObjects),
      __privateGet5(this, _cache3).deleteObjects(deletedIds),
      (_a = __privateGet5(this, _onEffects)) == null ? void 0 : _a.call(this, effects)
    ]);
  }
};
...
var CachingTransactionExecutor = class {
  constructor({
    ...
    __privateAdd6(this, _lastDigest, null);
  ...
  async executeTransaction({
    ...
    const results = await __privateGet6(this, _client).executeTransactionBlock({
      ...input,
  ...
  async applyEffects(effects) {
    __privateSet6(this, _lastDigest, effects.V2?.transactionDigest ?? null);
    await this.cache.applyEffects(effects);
  }
  async waitForLastTransaction() {
    if (__privateGet6(this, _lastDigest)) {
      await __privateGet6(this, _client).waitForTransaction({ digest: __privateGet6(this, _lastDigest) });
      __privateSet6(this, _lastDigest, null);
    }
  }
};
...
var SerialQueue = class {
  constructor() {
    __privateAdd7(this, _queue, []);
  }
  async runTask(task) {
    return new Promise((resolve, reject) => {
      __privateGet7(this, _queue).push(() => {
        task().finally(() => {
          __privateGet7(this, _queue).shift();
          if (__privateGet7(this, _queue).length > 0) {
            __privateGet7(this, _queue)[0]();
          }
        }).then(resolve, reject);
      });
      if (__privateGet7(this, _queue).length === 1) {
        __privateGet7(this, _queue)[0]();
      }
    });
  }
  ...
  runTask(task) {
    return new Promise((resolve, reject) => {
      if (this.activeTasks < this.maxTasks) {
        this.activeTasks++;
        task().finally(() => {
          if (__privateGet7(this, _queue2).length > 0) {
            __privateGet7(this, _queue2).shift()();
          } else {
            this.activeTasks--;
          }
        }).then(resolve, reject);
      } else {
        __privateGet7(this, _queue2).push(() => {
          task().finally(() => {
            if (__privateGet7(this, _queue2).length > 0) {
              __privateGet7(this, _queue2).shift()();
            } else {
...
var __privateSet7 = (obj, member, value, setter) => (__accessCheck8(obj, member, "write to private field"), setter ? setter.call(obj, value) : member.set(obj, value), value);
var _queue3;
var _signer;
var _cache4;
...
var SerialTransactionExecutor = class {
  constructor({
    ...
    __privateAdd8(this, _queue3, new SerialQueue());
    __privateAdd8(this, _signer);
    __privateAdd8(this, _cache4);
    __privateAdd8(this, _defaultGasBudget);
    __privateAdd8(this, _cacheGasCoin, async (effects) => {
      if (!effects.V2) {
        return;
      }
      const gasCoin = getGasCoinFromEffects(effects).ref;
      if (gasCoin) {
        __privateGet8(this, _cache4).cache.setCustom("gasCoin", gasCoin);
      } else {
        __privateGet8(this, _cache4).cache.deleteCustom("gasCoin");
      }
    });
    __privateAdd8(this, _buildTransaction, async (transaction) => {
      const gasCoin = await __privateGet8(this, _cache4).cache.getCustom("gasCoin");
      const copy = Transaction.from(transaction);
      if (gasCoin) {
        copy.setGasPayment([gasCoin]);
      }
      copy.setGasBudgetIfNotSet(__privateGet8(this, _defaultGasBudget));
      copy.setSenderIfNotSet(__privateGet8(this, _signer).toSuiAddress());
      return __privateGet8(this, _cache4).buildTransaction({ transaction: copy });
    });
    __privateSet7(this, _signer, signer);
    __privateSet7(this, _defaultGasBudget, defaultGasBudget);
    __privateSet7(this, _cache4, new CachingTransactionExecutor({
      client: options.client,
      cache: options.cache,
      onEffects: (effects) => __privateGet8(this, _cacheGasCoin).call(this, effects)
    }));
  }
  async applyEffects(effects) {
    return __privateGet8(this, _cache4).applyEffects(effects);
  }
  async buildTransaction(transaction) {
    return __privateGet8(this, _queue3).runTask(() => __privateGet8(this, _buildTransaction).call(this, transaction));
  }
  resetCache() {
    return __privateGet8(this, _cache4).reset();
  }
  waitForLastTransaction() {
    return __privateGet8(this, _cache4).waitForLastTransaction();
  }
  executeTransaction(transaction, options, additionalSignatures = []) {
    return __privateGet8(this, _queue3).runTask(async () => {
      const bytes = isTransaction(transaction) ? await __privateGet8(this, _buildTransaction).call(this, transaction) : transaction;
      const { signature } = await __privateGet8(this, _signer).signTransaction(bytes);
...
var __privateSet8 = (obj, member, value, setter) => (__accessCheck9(obj, member, "write to private field"), setter ? setter.call(obj, value) : member.set(obj, value), value);
var __privateMethod3 = (obj, member, method) => (__accessCheck9(obj, member, "access private method"), method);
var __privateWrapper = (obj, member, setter, getter) => ({
  set _(value) {
    __privateSet8(obj, member, value, setter);
  },
  get _() {
    return __privateGet9(obj, member, getter);
  }
});
var _signer2;
var _client2;
...
var ParallelTransactionExecutor = class {
  constructor(options) {
    __privateAdd9(this, _ParallelTransactionExecutor_instances);
    __privateAdd9(this, _signer2);
    __privateAdd9(this, _client2);
    __privateAdd9(this, _coinBatchSize);
    __privateAdd9(this, _initialCoinBalance);
    __privateAdd9(this, _minimumCoinBalance);
    __privateAdd9(this, _epochBoundaryWindow);
    __privateAdd9(this, _defaultGasBudget2);
    __privateAdd9(this, _maxPoolSize);
    __privateAdd9(this, _sourceCoins);
    __privateAdd9(this, _coinPool, []);
    __privateAdd9(this, _cache5);
    __privateAdd9(this, _objectIdQueues, /* @__PURE__ */ new Map());
    __privateAdd9(this, _buildQueue, new SerialQueue());
    __privateAdd9(this, _executeQueue);
    __privateAdd9(this, _lastDigest2, null);
    __privateAdd9(this, _cacheLock, null);
    __privateAdd9(this, _pendingTransactions, 0);
    __privateAdd9(this, _gasPrice, null);
    __privateSet8(this, _signer2, options.signer);
    __privateSet8(this, _client2, options.client);
    __privateSet8(this, _coinBatchSize, options.coinBatchSize ?? PARALLEL_EXECUTOR_DEFAULTS.coinBatchSize);
    __privateSet8(this, _initialCoinBalance, options.initialCoinBalance ?? PARALLEL_EXECUTOR_DEFAULTS.initialCoinBalance);
    __privateSet8(this, _minimumCoinBalance, options.minimumCoinBalance ?? PARALLEL_EXECUTOR_DEFAULTS.minimumCoinBalance);
    __privateSet8(this, _defaultGasBudget2, options.defaultGasBudget ?? __privateGet9(this, _minimumCoinBalance));
    __privateSet8(this, _epochBoundaryWindow, options.epochBoundaryWindow ?? PARALLEL_EXECUTOR_DEFAULTS.epochBoundaryWindow);
    __privateSet8(this, _maxPoolSize, options.maxPoolSize ?? PARALLEL_EXECUTOR_DEFAULTS.maxPoolSize);
    __privateSet8(this, _cache5, new CachingTransactionExecutor({
      client: options.client,
      cache: options.cache
    }));
    __privateSet8(this, _executeQueue, new ParallelQueue(__privateGet9(this, _maxPoolSize)));
    __privateSet8(this, _sourceCoins, options.sourceCoins ? new Map(options.sourceCoins.map((id) => [id, null])) : null);
  }
  resetCache() {
    __privateSet8(this, _gasPrice, null);
    return __privateMethod3(this, _ParallelTransactionExecutor_instances, updateCache_fn).call(this, () => __privateGet9(this, _cache5).reset());
  }
  async waitForLastTransaction() {
    await __privateMethod3(this, _ParallelTransactionExecutor_instances, updateCache_fn).call(this, () => __privateMethod3(this, _ParallelTransactionExecutor_instances, waitForLastDigest_fn).call(this));
  }
  async executeTransaction(transaction, options, additionalSignatures = []) {
    const { promise, resolve, reject } = promiseWithResolvers();
    const usedObjects = await __privateMethod3(this, _ParallelTransactionExecutor_instances, getUsedObjects_fn).call(this, transaction);
    const execute = () => {
      __privateGet9(this, _executeQueue).runTask(() => {
        const promise2 = __privateMethod3(this, _ParallelTransactionExecutor_instances, execute_fn).call(this, transaction, usedObjects, options, additionalSignatures);
        return promise2.then(resolve, reject);
      });
    };
    const conflicts = /* @__PURE__ */ new Set();
    usedObjects.forEach((objectId) => {
      const queue = __privateGet9(this, _objectIdQueues).get(objectId);
      if (queue) {
        conflicts.add(objectId);
        __privateGet9(this, _objectIdQueues).get(objectId).push(() => {
        ...
        __privateGet9(this, _objectIdQueues).set(objectId, []);
      }
    });
    if (conflicts.size === 0) {
      execute();
...
getUsedObjects_fn = async function(transaction) {
  ...
  await transaction.prepareForSerialization({ client: __privateGet9(this, _client2) });
  return usedObjects;
};
execute_fn = async function(transaction, usedObjects, options, additionalSignatures = []) {
  let gasCoin;
  try {
    transaction.setSenderIfNotSet(__privateGet9(this, _signer2).toSuiAddress());
    await __privateGet9(this, _buildQueue).runTask(async () => {
      ...
      transaction.setGasBudgetIfNotSet(__privateGet9(this, _defaultGasBudget2));
      ...
      await __privateGet9(this, _cache5).buildTransaction({ transaction, onlyTransactionKind: true });
    });
    const bytes = await transaction.build({ client: __privateGet9(this, _client2) });
    const { signature } = await __privateGet9(this, _signer2).signTransaction(bytes);
    const results = await __privateGet9(this, _cache5).executeTransaction({
      transaction: bytes,
      signature: [signature, ...additionalSignatures],
      options: {
        ...options,
    ...
    if (gasCoin && gasUsed && gasResult.owner === __privateGet9(this, _signer2).toSuiAddress()) {
      ...
      if (!usesGasCoin && remainingBalance >= __privateGet9(this, _minimumCoinBalance)) {
        __privateGet9(this, _coinPool).push({
        ...
        if (!__privateGet9(this, _sourceCoins)) {
          __privateSet8(this, _sourceCoins, /* @__PURE__ */ new Map());
        }
        __privateGet9(this, _sourceCoins).set(gasResult.ref.objectId, gasResult.ref);
      }
    }
    ...
    if (gasCoin) {
      ...
      __privateGet9(this, _sourceCoins).set(gasCoin.id, null);
    }
    await __privateMethod3(this, _ParallelTransactionExecutor_instances, updateCache_fn).call(this, async () => {
      await Promise.all([
        __privateGet9(this, _cache5).cache.deleteObjects([...usedObjects]),
    ...
    usedObjects.forEach((objectId) => {
      ...
      if (queue && queue.length > 0) {
        ...
        __privateGet9(this, _objectIdQueues).delete(objectId);
      }
    });
    __privateWrapper(this, _pendingTransactions)._--;
  }
...
updateCache_fn = async function(fn) {
  if (__privateGet9(this, _cacheLock)) {
    await __privateGet9(this, _cacheLock);
  }
  __privateSet8(this, _cacheLock, fn?.().then(
    () => {
...
waitForLastDigest_fn = async function() {
  const digest = __privateGet9(this, _lastDigest2);
  if (digest) {
    __privateSet8(this, _lastDigest2, null);
    await __privateGet9(this, _client2).waitForTransaction({ digest });
  }
};
getGasCoin_fn = async function() {
  if (__privateGet9(this, _coinPool).length === 0 && __privateGet9(this, _pendingTransactions) <= __privateGet9(this, _maxPoolSize)) {
    await __privateMethod3(this, _ParallelTransactionExecutor_instances, refillCoinPool_fn).call(this);
  }
  if (__privateGet9(this, _coinPool).length === 0) {
    throw new Error("No coins available");
  }
  const coin = __privateGet9(this, _coinPool).shift();
  return coin;
};
getGasPrice_fn = async function() {
  const remaining = __privateGet9(this, _gasPrice) ? __privateGet9(this, _gasPrice).expiration - __privateGet9(this, _epochBoundaryWindow) - Date.now() : 0;
  if (remaining > 0) {
    return __privateGet9(this, _gasPrice).price;
  }
  if (__privateGet9(this, _gasPrice)) {
    const timeToNextEpoch = Math.max(
      __privateGet9(this, _gasPrice).expiration + __privateGet9(this, _epochBoundaryWindow) - Date.now(),
      1e3
    );
    await new Promise((resolve) => setTimeout(resolve, timeToNextEpoch));
  }
  const state = await __privateGet9(this, _client2).getLatestSuiSystemState();
...
refillCoinPool_fn = async function() {
  const batchSize = Math.min(
    __privateGet9(this, _coinBatchSize),
    __privateGet9(this, _maxPoolSize) - (__privateGet9(this, _coinPool).length + __privateGet9(this, _pendingTransactions)) + 1
  );
  if (batchSize === 0) {
    return;
  }
  const txb = new Transaction();
  const address = __privateGet9(this, _signer2).toSuiAddress();
  txb.setSender(address);
  if (__privateGet9(this, _sourceCoins)) {
    const refs = [];
    const ids = [];
    for (const [id, ref] of __privateGet9(this, _sourceCoins)) {
      if (ref) {
        refs.push(ref);
      } else {
        ids.push(id);
    ...
    if (ids.length > 0) {
      const coins = await __privateGet9(this, _client2).multiGetObjects({
        ids
      });
      refs.push(
  ...
  const amounts = new Array(batchSize).fill(__privateGet9(this, _initialCoinBalance));
  ...
  const result = await __privateGet9(this, _client2).signAndExecuteTransaction({
    transaction: txb,
    signer: __privateGet9(this, _signer2),
    options: {
      showRawEffects: true
    }
  });
  ...
  effects.V2?.changedObjects.forEach(([id, { outputState }], i) => {
    ...
    __privateGet9(this, _coinPool).push({
      ...
      balance: BigInt(__privateGet9(this, _initialCoinBalance))
    });
  });
  if (!__privateGet9(this, _sourceCoins)) {
    __privateSet8(this, _sourceCoins, /* @__PURE__ */ new Map());
  ...
  __privateGet9(this, _sourceCoins).set(gasObject.objectId, gasObject);
  await __privateGet9(this, _client2).waitForTransaction({ digest: result.digest });
};
...
*/
//# sourceMappingURL=chunk-EDITML2W.js.map
